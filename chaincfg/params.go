...
type Params struct {
	...
	// to take effect.
	//
	// RuleChangeActivationWindow is the number of blocks in each threshold
...
var MainNetParams = Params{
	...
	RuleChangeActivationQuorum:     4032, // 10 % of RuleChangeActivationWindow * TicketsPerBlock
	RuleChangeActivationMultiplier: 3,    // 75%
	RuleChangeActivationDivisor:    4,
	RuleChangeActivationWindow:     2016 * 4, // 4 weeks
...
var TestNetParams = Params{
	...
	// The miner confirmation window is defined as:
	//   target proof of work timespan / target proof of work spacing
	RuleChangeActivationQuorum:     2520, // 10 % of RuleChangeActivationWindow * TicketsPerBlock
	RuleChangeActivationMultiplier: 3,    // 75%
	RuleChangeActivationDivisor:    4,
...
var SimNetParams = Params{
	...
	// The miner confirmation window is defined as:
	//   target proof of work timespan / target proof of work spacing
	RuleChangeActivationQuorum:     160, // 10 % of RuleChangeActivationWindow * TicketsPerBlock
	RuleChangeActivationMultiplier: 3,   // 75%
	RuleChangeActivationDivisor:    4,
	RuleChangeActivationWindow:     320, // 320 seconds
